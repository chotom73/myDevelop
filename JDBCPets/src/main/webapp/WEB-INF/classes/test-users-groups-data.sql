...
-- Ch 4 Salted User
insert into users(username, password, enabled, salt) values ('admin','admin',true,'admin');
insert into users(username, password, enabled, salt) values ('guest','guest',true,'guest');
