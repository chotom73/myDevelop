                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="#LINK" onclick="javascript:fncSelectLoginPolicyList('1')" style="selector-dummy:expression(this.hideFocus=false);"><img src="/images/img_search.gif" alt="search" />조회 </a>
                                    </div>
                                </li>
                            </ul>
                        </div>
