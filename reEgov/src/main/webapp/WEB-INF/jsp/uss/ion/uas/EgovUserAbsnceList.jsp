                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="<c:url value='/uss/ion/uas/selectUserAbsnceList.do'/>" onclick="javascript:fncSelectUserAbsnceList('1'); return false;"><img src="/images/img_search.gif" alt="search" />조회 </a>
                                    </div>                              
                                </li>
                            </ul>           
                        </div>          
