                        ...
                        <div class="sf_start">
                            <ul id="search_first_ul">
                                ...
                                <li>
                                    ...
                                    <a href="#LINK" onclick="javascript:fncSelectAuthorGroupPop()"><img src="/images/img_search.gif" alt="search" />팝업 </a>
                                </li>
                            </ul>
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="#LINK" onclick="javascript:fncSelectAuthorGroupList('1')" style="selector-dummy:expression(this.hideFocus=false);"><img src="/images/img_search.gif" alt="search" />조회 </a>
